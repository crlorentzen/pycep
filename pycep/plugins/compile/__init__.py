...
def load(raw_data: dict,  plugin, file_type, output: str, word_list, input_directory, export_dir, owner_id):
    ...
    render = markdown_in
    return render(raw_data, plugin, file_type, output, word_list, input_directory, export_dir, owner_id)
...
def markdown_in(raw_data: dict,  plugin, file_type, output: str, word_list, input_directory, export_dir, owner_id):
    ...
    compile_package_data(output, input_directory, export_dir, owner_id)
